"""
Django management command to import AdviesAanvraagBelgie from Excel.

Usage:
    python manage.py import_excel_belgie /path/to/file.xlsx
    python manage.py import_excel_belgie /path/to/file.xlsx --dry-run
    python manage.py import_excel_belgie /path/to/file.xlsx --max-results 5
"""

from django.core.management.base import BaseCommand
from comparator_app.api_excel_belgie import sync_excel_aanvragen_belgie


class Command(BaseCommand):
    help = 'Importeert AdviesAanvraagBelgie vanuit een Excel bestand (Belgische formulieren).'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS("  EXCEL IMPORT - ADVIES AANVRAGEN (BELGIË)"))
        self.stdout.write(self.style.SUCCESS("=" * 60))
        self.stdout.write("")
        ...
        try:
            success, errors, skipped = sync_excel_aanvragen_belgie(
