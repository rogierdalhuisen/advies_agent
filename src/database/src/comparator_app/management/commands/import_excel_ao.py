"""
Django management command to import OfferteArbeidsOngeschiktheid from Excel.

Usage:
    python manage.py import_excel_ao /path/to/file.xlsx
    python manage.py import_excel_ao /path/to/file.xlsx --dry-run
    python manage.py import_excel_ao /path/to/file.xlsx --max-results 5
"""

from django.core.management.base import BaseCommand
from comparator_app.api_excel_ao import sync_excel_offertes_ao


class Command(BaseCommand):
    help = 'Importeert OfferteArbeidsOngeschiktheid vanuit een Excel bestand.'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS("  EXCEL IMPORT - OFFERTE ARBEIDSONGESCHIKTHEID"))
        self.stdout.write(self.style.SUCCESS("=" * 60))
        self.stdout.write("")
        ...
        try:
            success, errors, skipped = sync_excel_offertes_ao(
