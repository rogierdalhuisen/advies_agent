"""
Django management command to import AllianzCareQuote from Excel.

Usage:
    python manage.py import_excel_allianz /path/to/file.xlsx
    python manage.py import_excel_allianz /path/to/file.xlsx --dry-run
    python manage.py import_excel_allianz /path/to/file.xlsx --max-results 5
"""

from django.core.management.base import BaseCommand
from comparator_app.api_excel_allianz import sync_excel_allianz_quotes


class Command(BaseCommand):
    help = 'Importeert AllianzCareQuote vanuit een Excel bestand.'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS("  EXCEL IMPORT - ALLIANZ CARE QUOTE"))
        self.stdout.write(self.style.SUCCESS("=" * 60))
        self.stdout.write("")
        ...
        try:
            success, errors, skipped = sync_excel_allianz_quotes(
